...
public class BallOnGraph extends Application {
	@Override
	public void start(Stage primaryStage) {
		...
		pane.getChildren().addAll(polyline1, line1, line2, line3, line4, line5, line6, text1, text2, text3, text4,
				text5, text6, text7, circle);
		// Create a scene and place it in the stage
		Scene scene = new Scene(pane, 400, 250);
		primaryStage.setTitle("MoedA 10118"); // Set the stage title
