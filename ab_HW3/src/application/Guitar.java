...
public class Guitar extends StringInstrument {
	...
	public Guitar(String brand, Number price, int numOfStrings, String type) {
		...
		case ELECTRIC:
			if (numOfStrings < ELEC_MIN_NUM_OF_STRINGS || numOfStrings > ELEC_MAX_NUM_OF_STRINGS)
				throw new InputMismatchException("Acoustic Guitars have "+ ELEC_MIN_NUM_OF_STRINGS+"-"+ELEC_MAX_NUM_OF_STRINGS+" strings, not " + numOfStrings);
			break;
		}
	}
	...
	public Object clone() throws CloneNotSupportedException {
		Guitar newGuitar = new Guitar(super.getBrand(), super.getPrice(), super.getNumOfStrings(), this.getType());
		return newGuitar;
	}
